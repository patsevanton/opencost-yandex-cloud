...
В этом проекте предполагается, что **kube-state-metrics всегда есть** (он входит в VictoriaMetrics K8s Stack). Ниже — зачем вообще дубликаты и что дают опции в `opencost-values.yaml`.
