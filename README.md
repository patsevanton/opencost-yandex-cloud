...
- CPU: строка с `core_hour` и `Regular VM computing resources, Intel Ice Lake, 100% vCPU` (id `dn2k3vqlk9snp1jv351u`, цена 1.1529 RUB).
- RAM: строка с `gbyte_hour` и `Regular VM computing resources, Intel Ice Lake, RAM` (id `dn2ilq72mjc3bej6j74p`, цена 0.3074 RUB).
- HDD: строка с `gbyte_hour` и `Standard disk drive (HDD)` (id `dn2al287u6jr3a710u8g`, цена 0.0045 RUB).
