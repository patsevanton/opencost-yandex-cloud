...
Пример: в skus.txt для Regular VM Intel Ice Lake 100% vCPU указано `1.3066 RUB` за `core_hour`. Тогда `CPU = "953.818"` (1.3066 × 730). Аналогично для RAM (например 0.3404 ₽/ГБ×час → 248.492) и storage (0.0045 ₽/ГБ×час для HDD → 3.285).
...
- HDD: строка с `gbyte_hour` и `Standard disk drive (HDD)` (id `dn2al287u6jr3a710u8g`, цена 0.0182 RUB).
