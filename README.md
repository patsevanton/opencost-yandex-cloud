...
**Примечание:** при открытии http://opencost.apatsev.org.ru по умолчанию всегда отображается USD; переключить на RUB можно в самом UI, но при каждом новом заходе в UI opencost снова будет USD.
